...
<div align="center">
    <table border="1" cellspacing="0" width="1220px" align="center" class="camposSinBordes">
        ...
        <tr style="background-color: #DADADA">
            <th class="camposSinBordes" data-step='23' data-intro='Please indicate.'>
            ...
            <th class="camposSinBordes" data-step='24' data-intro='Please indicate the unit of measure.'>
            ...
            <th class="camposSinBordes" data-step='25' data-intro='Quantity of material used.'>
            ...
            <th class="camposSinBordes" data-step='26' data-intro='Material cost per unit of measure'>
            ...
            <th class="camposSinBordes calculatedField" data-step='27' data-intro='This is the material cost total (formulated cell not to be completed by Supplier).<br/>Formula:<br/>Quantity x Cost/Unit'>
                <asp:Label ID="lblMaterialTotal" runat="server" Width="70px">0.00</asp:Label>
            </th>
            <th class="camposSinBordes" data-step='28' data-intro='Outside services needed.'>
            ...
            <th class="camposSinBordes" data-step='29' data-intro='Cost of the outside service.'>
            ...
            <th class="camposSinBordes calculatedField" data-step='30' data-intro='This is the outside service cost total (formulated cell not to be completed by Supplier).<br/>Formula:<br/>Quantity x Cost/Unit'>
                <asp:Label ID="lblServiceTotal" runat="server" Width="70px">0.00</asp:Label>
            </th>
            <th class="camposSinBordes" data-step='31' data-intro='Percentage of scrap.'>
            ...
            <th class="camposSinBordes calculatedField" data-step='32' data-intro='This is the scrap cost total (formulated cell not to be completed by Supplier).<br/>Formula:<br/>(Material Total + Service Total) x Scrap Value'>
                <asp:Label ID="lblScrapCost" runat="server" Width="70px">0.00</asp:Label>
            </th>
            <th class="camposSinBordes" data-step='33' data-intro='Enter directly labor rate.'>
            ...
            <th class="camposSinBordes" data-step='34' data-intro='Enter the number of standards hours required per part.'>
            ...
            <th class="camposSinBordes calculatedField" data-step='35' data-intro='This is the labor cost total (formulated cell not to be completed by Supplier).<br/>Formula:<br/>Directly Hrly Labor Rate x Std Hrs.'
                data-position='left'>
                <asp:Label ID="lblLaborCost" runat="server" Width="70px">0.00</asp:Label>
            </th>
            <th class="camposSinBordes" data-step='36' data-intro='Enter your total burden cost per unit.'
                data-position='left'>
            ...
            <th class="camposSinBordes calculatedField" data-step='37' data-intro='This is the burden cost total (formulated cell not to be completed  by Supplier).<br/>Formula:<br/>=Burden'
                data-position='left'>
                <asp:Label ID="lblBurdenTotal" runat="server" Width="50px">0.00</asp:Label>
            </th>
            <th class="camposSinBordes" colspan='2' data-step='38' data-intro='If your information in this line is correct, press this button to add it to the list.'
                data-position='left'>
