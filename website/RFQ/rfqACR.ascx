    ...
    <tr>
        <td align="left">
            <div style="width: 290px" align="right">
                Year
                <asp:TextBox ID="txtYear" runat="server" Style="text-align: right" Width="40px" TabIndex="26"></asp:TextBox>
                Cost %
                <asp:TextBox ID="txtCost" runat="server" Style="text-align: right" Width="40px" TabIndex="27"></asp:TextBox>
