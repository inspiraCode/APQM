...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [SIFHeaderKey], [BOMHeaderKey], [InquiryNumber], [Priority], [Revision], [SalesPerson], [CostModelLoc], [TopPartNumber], [CustomerName] FROM [viewSIF_ReadAll]"></asp:SqlDataSource>
    <div align="center">
<asp:GridView ID="GridViewSif" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="CostModelLoc" HeaderText="Cost Model Location" 
            SortExpression="CostModelLoc" />
        <asp:ButtonField CommandName="selectSIF" DataTextField="TopPartNumber" 
            HeaderText="Top Part Number" SortExpression="TopPartNumber" />
...
<script type="text/javascript">
    ...
    jQuery('#<%= this.GridViewSif.ClientID %>').dataTable();
    });
</script>