...
<div id="quoteSection">
    ...
    <div align="center">
        <table cellspacing="0" style="min-width: 995px; max-width: 995px; width: 1053px;">
            ...
            <tr>
                ...
                <td align="left" class="style27" data-step='5' data-intro='This is a number used for track this RFQ.'>
                ...
                <td align="left" class="style29" data-step='11' data-intro='This is your company name, if it is wrong, please save first this RFQ without finilizing, and then go back to correct it.'>
            ...
            <tr>
                ...
                <td align="left" class="style29" data-step='12' data-intro='This is your Manufacturing Location, if it is wrong, please save first this RFQ without finilizing, and then go back to correct it.'>
            ...
            <tr>
                ...
                <td align="left" class="style27" rowspan="2" data-step='9' data-intro='This is the material or name of the piece to quote.'>
            ...
            <tr>
                ...
                <td align="left" class="style27" data-step='10' data-intro='Sometimes you can see here the target price if it was specify by Purchasing department.'>
            ...
            <tr>
                <td align="center">
                    ...
                    <div style="border-radius: 10px; border: solid #D3D3D3; background-color: #D3D3D3;
                        display: inline-block;" data-step='20' data-intro='This is FYI.'>
    ...
    <div align="center">
        <table cellspacing="0" class="style55">
            <tr align="center">
                ...
                <td rowspan="5">
                    <table>
                        ...
                        <tr>
                            <td align="right" data-step='49' data-intro='Enter the MOQ.'>
                                MOQ
                        ...
                        <tr>
                            <td align="right" data-step='50' data-intro='Enter the Brand.'>
                                Brand
            ...
            <tr>
                <td class="style56" colspan="2" align="right" data-step='43' data-intro='Please provide tooling information i.e. Number of cavities, progressions etc.'>
            ...
            <tr>
                ...
                <td class="style62" align="right" data-step='44' data-intro='Enter Production Tooling Cost.'>
            ...
            <tr>
                ...
                <td class="style62" align="right" data-step='45' data-intro='Enter Prototype Tooling Cost.'>
            ...
            <tr>
                ...
                <td class="style62" align="right" data-step='46' data-intro='Enter Prototype Piece Cost.'>
