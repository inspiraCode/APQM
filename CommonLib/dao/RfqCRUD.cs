...
public class RfqCRUD : ICRUD<RFQ>
{
    ...
    public RFQ readById(long id)
    {
        ...
        string query = "SELECT RFQHeaderKey, BOMDetailKey, SupplierMasterKey, RFQNumberKey, DrawingLevel, " +
            ...
            "LeadTimePPAP_FAIR, LeadTimeFirstProductionOrder, LeadTimeNormalProductionOrders, ExceptionTo100ToPrint, Quote100ToPrint, LastEmail, Um  " +
        ...
        if (sqlConnection != null)
        {
            ...
            if (table.Rows.Count > 0)
            {
                ...
                rfq.Um = table.Rows[0][49].ToString();
    ...
    public List<RFQ> readByBOMDetailKey(long id)
    {
        ...
        if (sqlConnection != null)
        {
            ...
            for (int i = 0; i < table.Rows.Count; i++)
            {
                ...
                rfq.Um = table.Rows[i][49].ToString();
                recordset.Add(rfq);
            }
        }
        return recordset;
